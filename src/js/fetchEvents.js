...
//подключение списка стран в выбор через массив обьектов
const countries = [
      {
      "countryCode":"US",
...
const list = document.getElementById('choose country');
// console.log(list);
const listMarkup = createListCountryMarkup(countries);
...
function createListCountryMarkup(countries) {
    ...
    return countries.map(({ countryCode, name }) => {
        return `
